...
//This also different than the modernized...one of the lines near the end is in a different  paragraph. Also, in the original PDF, his name isn't there so I left as it is in the original.
